    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: true }">
        ...
        >
            ...
            <nav class="flex-grow px-4 mt-4 space-y-1">
                ...
                <a href="{{ route('events') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-colors {{ request()->routeIs('events') ? 'bg-[#C9A050] text-white' : 'text-white/60 hover:bg-white/5 hover:text-white' }}">
                ...
                <a href="{{ route('notifications') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-colors {{ request()->routeIs('notifications') ? 'bg-[#C9A050] text-white' : 'text-white/60 hover:bg-white/5 hover:text-white' }}">
            ...
            <div class="mt-auto px-4 pt-4 pb-6">
                ...
                <form method="POST" action="{{ route('logout') }}" class="mt-3">
                    @csrf
                    <button type="submit" class="w-full flex items-center justify-center space-x-2 py-2.5 text-xs font-medium text-white/60 hover:text-white hover:bg-white/5 transition-colors border border-white/10 rounded-lg">
